...
# load results
model_path = '/home/riccardoz/Documents/Git/BP-MPC_improving_closed_loop_MPC_performance/.models/2025_07_09_17_12_43_random_linear_models_NX_4_POLE_MAG_-5.0_to_1.0_N_MODELS_50_NOISE.pkl'
results_ce_path = '/home/riccardoz/Documents/Git/BP-MPC_improving_closed_loop_MPC_performance/.results/gd_CE_2025_07_09_17_12_43_random_linear_models_NX_4_POLE_MAG_-5.0_to_1.0_N_MODELS_50_NOISE.pkl'
...
cost_ce = np.array([elem['training_cost']['alg_trained'] for elem in results_ce]).squeeze()
cost_ce_first = np.array([elem['training_cost']['alg_untrained'] for elem in results_ce]).squeeze()
optimal_cost_ce = np.array([elem['training_cost']['best_feedback'] for elem in results_ce]).squeeze()
...
diff_best_ce_sorted = diff_best_ce
diff_first_ce_sorted = diff_first_ce
...
plt.bar(x, diff_first_ce_sorted, color='tab:blue', label='b')
plt.bar(x, diff_best_ce_sorted, color='tab:orange', label='a', alpha=0.3)
